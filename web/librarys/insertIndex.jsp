...
<div id="update">
    ...
    <form class="form-horizontal" method="get" action="${pageContext.request.contextPath}/insert">
        ...
        <div class="form-group">
            ...
            <textarea rows="6" cols="68" name="face" style="margin-left: 17px;"></textarea>
        </div>
        <div class="form-group">
            <label class="col-xs-3 control-label">出版时间</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" name="create" placeholder="出版时间">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="address" placeholder="位置">
            </div>
        </div>
        <div class="form-group">
